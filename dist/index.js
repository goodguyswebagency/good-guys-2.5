...
(() => {
  ...
  var excerpts = Array.from(document.querySelectorAll(".bredcrumbs-manuell"));
  function truncateText() {
    if (window.matchMedia("(max-width: 500px)").matches) {
      excerpts.forEach((item) => {
        const lastParagraph = item.querySelector("p:last-of-type");
  ...
  var navDropWrapper = document.querySelectorAll(".nav-drop-wrapper");
  var navDropContent = document.querySelectorAll(".nav-drop_content");
  ...
  var navDropList = document.querySelector(".nav-drop-list");
  var linkWrappers = navDropList.querySelectorAll(".nav-drop_link-wrapper");
  linkWrappers.forEach((wrapper) => {
    wrapper.addEventListener(
      "click",
      () => {
        if (wrapper.classList.contains("active-link-wrapper")) {
          linkWrappers.forEach(
            (item) => item.classList.remove("active-link-wrapper")
          );
        } else {
          linkWrappers.forEach(
            (item) => item.classList.remove("active-link-wrapper")
  ...
  var handleLinksAfterScroll = debounce(handleLinks, 200);
  handleLinks();
  ...
  window.addEventListener(
    ...
    function() {
      ...
      if (currentScroll > 0) {
        navbar2.classList.add("menu-background");
      } else {
        navbar2.classList.remove("menu-background");
      }
      lastScrollTop = currentScroll <= 0 ? 0 : currentScroll;
    },
    { passive: true }
  );
  var mediaSublinks = document.querySelectorAll(
  ...
  // src/js/components/customCursor.js
  ...
  var pageLanguage = document.querySelector(
  ...
  // src/js/animations/animateFromBottom.js
    ...
    const applyAnimation = (elements) => {
      elements.forEach((element) => {
        gsapWithCSS.fromTo(
          ...
          {
            y: 50,
            // Start 50px below the original position
            opacity: 0
          ...
          },
          {
            ...
            scrollTrigger: {
              trigger: element,
              // Use the element as the trigger
              start: "top 95%",
              // Start the animation when the top of the element is 95% from the top of the viewport
              toggleActions: "play none none none"
              // Play only when scrolling down, do nothing on reverse
              // markers: true,
            }
          }
        );
  ...
  // node_modules/.pnpm/lenis@1.3.8/node_modules/lenis/dist/lenis.mjs
  var version = "1.3.8";
  ...
  // src/js/animations/lenisSmoothScroll.js
  var lenis = new Lenis({
    lerp: 0.3,
    // scroll smoothness
    wheelMultiplier: 0.9,
  ...
  var navInnerLinks = document.querySelectorAll("[data-lenis-prevent]");
  ...
  var navMobileSublinks = document.querySelectorAll("[lenis-scroll-fix]");
  ...
  var testimonialVideo = document.querySelectorAll(
