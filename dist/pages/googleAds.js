...
(() => {
  ...
  // src/js/components/adsSlider.js
  var adsSlider;
  function updateButtonOpacity() {
    ...
    if (adsSlider) {
      ...
      const totalSlides = adsSlider.snapGrid.length;
      if (activeIndex === 0) {
  ...
  // src/js/animations/developmentProcess.js
  var slideNumbersTracks = document.querySelectorAll(
    ".process_slide-numbers-track"
  );
  function updateActiveSlideClasses(slideIndex) {
    slideNumbersTracks.forEach((track) => {
      track.className = "process_slide-numbers-track";
      track.classList.add(`active-slide-${slideIndex + 1}`);
    });
  }
  var servicesSlider;
  ...
  // src/js/animations/heroIconsMovement.js
  ...
  function animateIcon(icon) {
    ...
    function move() {
      ...
      gsapWithCSS.to(icon, {
        ...
        // Duration of 2 seconds for the transition
        ease: "power1.inOut",
        // Smooth easing for the movement
        onComplete: move
        // Call move again when the animation is done to repeat
      });
    }
    move();
  }
  var icons = document.querySelectorAll(".hero-dev_media-icon");
  if (icons.length > 0) {
