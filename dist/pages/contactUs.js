...
(() => {
  ...
  // src/js/pages/contactUs.js
  var nameForm = document.querySelector("#full-name");
  var companyForm = document.querySelector("#company-name");
  var emailForm = document.querySelector("#company-email");
  var submitButton = document.querySelector("#contact-submit");
  var submitWrapper = document.querySelector("#submit-wrapper");
  var buttonText = document.querySelector("#submit-wrapper .button-text");
  ...
  var applyInvalidStyles = (el) => {
    el.classList.add("input-error-state");
  };
  var applyValidStyles = (el) => {
  ...
  var observer = new MutationObserver(updateDivContent);
  ...
  var languageInput = document.querySelector(".contact-hidden-language-input");
  if (languageInput) {
