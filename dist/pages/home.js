...
(() => {
  ...
  // src/js/components/servicesSlider.js
  var servicesSlider;
  function initSwiper() {
    const screenWidth2 = window.innerWidth;
    if (screenWidth2 > 991 || screenWidth2 < 767) {
      if (!servicesSlider) {
        servicesSlider = new Swiper(".services-slider", {
          modules: [Scrollbar, Navigation],
          direction: "horizontal",
          slidesPerView: screenWidth2 < 767 ? "auto" : 4,
          spaceBetween: 0,
          scrollbar: {
            el: ".swiper-scrollbar",
            hide: false,
  ...
  // src/js/components/featuredWorkSlider.js
  var featuredWorkSlider;
  var spaceBetweenValue = -150;
  ...
  featuredWorkSlider = new Swiper(".featured-slider", {
    modules: [Pagination],
    slidesPerView: "auto",
    // Adjust based on how many slides you want to show
    centeredSlides: true,
  ...
  // src/js/animations/heroImageFlip.js
  gsapWithCSS.registerPlugin(ScrollTrigger2);
  var videoElement = document.querySelector("#home-hero-video-element");
  videoElement.play();
  gsapWithCSS.set(videoElement, { clipPath: "inset(15%)" });
  gsapWithCSS.to(videoElement, {
    clipPath: "inset(0%)",
    ease: "none",
    scrollTrigger: {
  ...
  var videoContainer = document.querySelector(".home-hero_video");
  var videoElement2 = document.querySelector("#home-hero-video-element");
  videoElement2.style.backgroundImage = `url("${videoContainer.getAttribute("data-poster-url")}")`;
  var videoUrls = videoContainer.getAttribute("data-video-urls").split(",");
  ...
  videoElement2.appendChild(mp4Source);
  videoElement2.appendChild(webmSource);
