...
(() => {
  ...
  var videos = document.querySelectorAll(".testimonial-slide_media-video");
  ...
  var overlays = document.querySelectorAll(".testimonial-slide_media-overlay");
  ...
  var accordions = document.querySelectorAll(".faq_accordion");
        ...
        gsapWithCSS.fromTo(
          ...
          },
          {
            ...
            scrollTrigger: {
              ...
              start: "top 80%",
              // Start the animation when the top of the SVG is 80% from the top of the viewport
              end: "top 50%",
              // End the animation when the top of the SVG is 50% from the top
              scrub: true
  ...
  steps.forEach((step) => {
    ...
    gsapWithCSS.fromTo(
      ...
      },
      {
        ...
        stagger: 0.2,
        // Stagger delay of 0.2s between each child element
        scrollTrigger: {
          trigger: closestVisibleStepLine || step,
          // Use the closest '.step_line' or fallback to the step itself
          start: "top 55%",
          // Start the animation when the top of the 'step' element is 55% from the top of the viewport
          end: "top 40%",
          onEnter: () => {
  ...
  // src/js/animations/wordBackgroundHighlight.js
  gsapWithCSS.registerPlugin(ScrollTrigger2);
  ...
  // src/js/animations/scrubOpacity.js
  gsapWithCSS.registerPlugin(ScrollTrigger2);
  setTimeout(() => {
    function runSplit() {
...
gsap/ScrollTrigger.js:
  ...
  *)
*/
//# sourceMappingURL=webflowSeo.js.map
